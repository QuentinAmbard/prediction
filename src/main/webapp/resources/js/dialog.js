...
MUX.Dialog = new Class({
	...
	initialize: function(options) {
		...
		this.box.innerHTML = '<div class="mux-dialog-header"><span class="mux-dialog-header-dummy-title">&nbsp;</span><span class="mux-dialog-header-title"></span></div><div class="mux-dialog-dummy-header"></div><div class="mux-dialog-content"></div><div class="mux-dialog-footer"><div class="mux-dialog-footer-border"></div><div class="mux-dialog-footer-buttons"></div></div><div class="mux-dialog-resize-icon mux-hidden"></div>';
